...
public class MediaMuxerWrapper {
	...
	public synchronized void pauseThincarScreenData() {
		if (mVideoEncoder != null)
			mVideoEncoder.pauseScreenData();
	}

	public synchronized void resumeThincarScreenData() {
		if (mVideoEncoder != null)
			mVideoEncoder.resumeScreenData();
	}
