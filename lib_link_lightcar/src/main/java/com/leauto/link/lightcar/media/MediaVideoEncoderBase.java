...
public abstract class MediaVideoEncoderBase extends MediaEncoder {
	...
	public MediaVideoEncoderBase(Context context, final MediaMuxerWrapper muxer, final MediaEncoderListener listener, final int width, final int height)
	{
		super(context, muxer, listener);
		mWidth = width;
		mHeight = height;
	}
